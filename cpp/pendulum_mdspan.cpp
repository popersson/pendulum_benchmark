...
State column(Matrix y, std::size_t n)
{
    return {y[0, n], y[1, n], y[2, n], y[3, n]};
}

void set_column(Matrix y, std::size_t n, const State& state)
{
...
void runge5(const auto& f, const State& y0, double h, Matrix y)
{
    ...
    for (std::size_t n = 0; n < N; ++n) {
        ...
        set_column(y, n + 1, yn + h * (17.0 * k1 + 100.0 * k3 + 2.0 * k4
